...
Reviewing a PR: run `/review-pr <pr>` yourself and map its verdict onto the protocol (APPROVE -> PASS, otherwise FAIL to eng-1). Hand a FAIL to the engineer as `/fix-pr <pr>`.
